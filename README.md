...
Для обучения перцептрона, вызывается метод learn, принимающийй на вход список тестовых входных сигналов, список ожидаемых выходных сигналов, и число эпох, на протяжении которых будет происходит обучение. Данный метод возвращает зависимость ошибки (как список) и весов нейронов (как многоуровневый словарь) от пройденных эпох.
